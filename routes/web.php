...
Route::get('/front/perfil', [App\Http\Controllers\FrontController::class, 'vistaperfil'])->name('vPerfil');
Route::post('/usuarios/perfil', [App\Http\Controllers\FrontController::class, 'actualizarPerfil'])->name('vp.actualizar');
//Route::get('/usuarios/{id?}/perfil', [App\Http\Controllers\UsuarioController::class, 'buscarPerfil'])->name('vp.buscar');
//PQRS
...
Route::post('/carrito/pagado', [App\Http\Controllers\CarritoController::class, 'pagado'])->name('cart.pagado');
...
Route::post('/Direcciones/mun', [App\Http\Controllers\DireccionController::class, 'municipios'])->name('dir.municipios');
Route::post('/Direcciones/add', [App\Http\Controllers\DireccionController::class, 'agregar'])->name('dir.agregar');
