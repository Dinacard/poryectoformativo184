...
<form method="post" action="{{ Route('pro.guardar') }}">
  ...
  <div class="col-md-4">
    ...
    <div class="input-group">
      ...
      <input type="number" class="form-control" min=1 name="valor" >
    </div>
  </div>
  ...
  <br><br>
    ...
    <input type="number" name="descuento" class="form-control" min="1">
  </div>

  <div class="col-md-4">
  <br><br>
            <label class="form-label">Garantia</label>
            <input type="number" name="garantia" class="form-control" min="1">
  <br>
  </div>
